...
export default function TotalOnslaughtPage() {
  return (
    <main className="min-h-screen overflow-hidden bg-[#06101a] text-foreground">
      <section className="relative border-b border-accent/20 px-6 pb-20 pt-36 sm:px-10 lg:px-12 lg:pb-28 lg:pt-44" aria-labelledby="total-onslaught-title">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_75%_25%,rgba(186,139,62,0.13),transparent_38%),linear-gradient(155deg,#0b2532_0%,#06101a_64%)]" />
        <div className="relative mx-auto max-w-[1200px]">
          ...
          <h1 id="total-onslaught-title" className="mt-5 max-w-5xl font-serif text-[clamp(4rem,9vw,8.5rem)] font-light leading-[0.83] tracking-[-0.025em]">Total<br /><em className="text-[#d4a653]">Onslaught</em></h1>
      ...
      <section className="border-y border-accent/20 bg-[#0a1926] px-6 py-16 sm:px-10 lg:px-12 lg:py-20" aria-labelledby="study-carefully-heading">
