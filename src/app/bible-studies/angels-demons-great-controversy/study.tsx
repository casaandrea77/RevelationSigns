...
export function AngelsDemonsStudyContent() {
  ...
  return <main className="nephilim-page angels-page">
    ...
    <section className="final-section angels-final"><div className="shell final-inner"><p className="eyebrow light">The outcome is certain</p><h2>Stand in truth.<br /><em>Not in fear.</em></h2><p>The controversy is real, but Christ has not left His people defenceless—and evil will not continue forever.</p><blockquote>“Greater is he that is in you, than he that is in the world.”<span>1 John 4:4</span></blockquote><div className="next-study-card next-study-coming"><span><small>Next study · Coming soon</small><b>The State of the Dead<br />Can the Dead Speak to the Living?</b></span><i>—</i></div></div></section>
